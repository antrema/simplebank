...
import (
	...
	"antrema.com/golang_014_008/util"
	"github.com/stretchr/testify/require"
)

func createRandomTransfer(t *testing.T, account_from, account_to Golang014Account) Golang014Transfer {
...
func TestGetTranfert(t *testing.T) {
	account_from := createRandomAccount(t)
	account_to := createRandomAccount(t)
